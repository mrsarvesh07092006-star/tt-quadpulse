...
Observe PWM outputs on uo_out[3:0]. Connect an LED through a 470 Ω resistor to uo_out[0]
...
- LED + 470 Ω resistor for visual duty cycle demo (no oscilloscope needed)
